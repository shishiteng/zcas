...
am__installdirs = "$(DESTDIR)$(confdir)" "$(DESTDIR)$(dictdir)" \
	"$(DESTDIR)$(licensedir)"
DATA = $(conf_DATA) $(dict_DATA) $(license_DATA)
...
ACLOCAL = ${SHELL} /home/sst/work/github/zcas/missing aclocal-1.14
ALLOCA = 
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /home/sst/work/github/zcas/missing autoconf
AUTOHEADER = ${SHELL} /home/sst/work/github/zcas/missing autoheader
AUTOMAKE = ${SHELL} /home/sst/work/github/zcas/missing automake-1.14
AWK = gawk
...
LTLIBPTH = 
LTLIBTHREAD = 
MAKEINFO = ${SHELL} /home/sst/work/github/zcas/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
...
abs_builddir = /home/sst/work/github/zcas
abs_srcdir = /home/sst/work/github/zcas
abs_top_builddir = /home/sst/work/github/zcas
abs_top_srcdir = /home/sst/work/github/zcas
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/sst/work/github/zcas/install-sh
...
install-licenseDATA: $(license_DATA)
	...
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(licensedir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(licensedir)" || exit 1; \
	fi; \
	for p in $$list; do \
	  if test -f "$$p"; then d=; else d="$(srcdir)/"; fi; \
	  echo "$$d$$p"; \
...
uninstall-licenseDATA:
	...
	@list='$(license_DATA)'; test -n "$(licensedir)" || list=; \
	files=`for p in $$list; do echo $$p; done | sed -e 's|^.*/||'`; \
	dir='$(DESTDIR)$(licensedir)'; $(am__uninstall_files_from_dir)
...
installdirs-am:
	for dir in "$(DESTDIR)$(confdir)" "$(DESTDIR)$(dictdir)" "$(DESTDIR)$(licensedir)"; do \
...
install-data-am: install-confDATA install-dictDATA install-licenseDATA
...
uninstall-am: uninstall-confDATA uninstall-dictDATA \
	uninstall-licenseDATA
...
.PHONY: $(am__recursive_targets) CTAGS GTAGS TAGS all all-am \
	...
	install-info install-info-am install-licenseDATA install-man \
	install-pdf install-pdf-am install-ps install-ps-am \
	install-strip installcheck installcheck-am installdirs \
	installdirs-am maintainer-clean maintainer-clean-generic \
	mostlyclean mostlyclean-generic mostlyclean-libtool pdf pdf-am \
	ps ps-am tags tags-am uninstall uninstall-am \
	uninstall-confDATA uninstall-dictDATA uninstall-licenseDATA
